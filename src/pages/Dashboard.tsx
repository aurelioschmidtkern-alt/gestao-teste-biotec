...
export default function Dashboard() {
  ...
  return (
    <motion.div className="max-w-7xl mx-auto p-8 space-y-8" initial="initial" animate="animate" variants={stagger}>
      {/* Header */}
      <motion.div className="flex items-center justify-between flex-wrap gap-4" variants={fadeInUp}>
        <div>
